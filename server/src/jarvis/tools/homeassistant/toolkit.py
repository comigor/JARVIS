...
class HomeAssistantToolkit(BaseToolkit):
    ...
    def get_tools(self) -> List[BaseTool]:
        return [
            ...
            HomeAssistantControlEntitiesTool(base_url = self.base_url, api_key = self.api_key),
            HomeAssistantGetEntityTool(base_url = self.base_url, api_key = self.api_key),
            HomeAssistantListEntitiesStateTool(base_url = self.base_url, api_key = self.api_key),
        ]
