...
class GoogleTasksTool(BaseTool):
    ...
    async def _arun(
        ...
        try:
            ...
            return tasks, None  # Success, return tasks JSON and no error

        except Exception as e:
            error_str = str(e)
            return None, error_str  # Error occurred, return None for tasks and the error string
...
class CreateGoogleTaskTool(BaseTool):
    ...
    async def _arun(self, title: str, due_datetime: datetime):
        try:
            ...
            return created_task, None  # Success, return the created task JSON and no error

        except Exception as e:
            error_str = str(e)
            return None, error_str  # Error occurred, return None for the created task and the error string
